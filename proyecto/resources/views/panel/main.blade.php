        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ route("turismo.inicio") }}" data-toggle="tooltip" title="Turismo" class="nav-link pl-3 pr-3"> <i class="mr-1 fa fa-bus"></i>Turismo</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" data-toggle="tooltip" title="Reportes" class="nav-link pl-3 pr-3"> <i class="mr-1 fa fa-file-pdf"></i>Reportes</a>
                    </li>
                    <li class="nav-item">
