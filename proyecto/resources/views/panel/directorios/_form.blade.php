<div class="row  m-reset pt-1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 m-table mt-3">
        ...
        <div class="form-group col m-table">
            ...
            <input type="text" class="form-control" id="nombre-a"placeholder="Introduce el Nombre Completo" name="nombre" value="{{ old('nombre',$directorio->nombre_completo) }}">
        ...
        <div class="form-group col m-table">
            ...
            <input type="text" class="form-control" id="cargo-a" placeholder="Introduce Cargo que Desempeña" name="cargo" value="{{ old('cargo',$directorio->cargo) }}">
        ...
        <div class="form-group col m-table">
            ...
            <input type="email" class="form-control" id="correo-a" placeholder="Introduce el Correo Electrónico" name="email" value="{{ old('email',$directorio->correo_contacto) }}">
        </div>
        <div class="row m-reset">
            <div class="form-group col-8 m-table">
                <label for="telefono-a">Teléfono de Contacto*</label>
                <input type="number" class="form-control" id="telefono-a" placeholder="Introduce el Número de Teléfono" name="phone" value="{{ old('phone',$directorio->tel_contacto) }}">
            ...
            <div class="form-group col-4 m-table">
                ...
                <input type="number" class="form-control" id="telefono-ext" placeholder="Extención" maxlength="10" name="ext" value="{{ old('ext',$directorio->ext) }}">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 m-table">
        <div class="form-group m-table mt-3">
            <label class="ml-3" for="telefono-a">Cargar Imagen*</label>
            <input class="form-control d-none" type="file" accept="image/*" name="imagen" id="dir-img">
