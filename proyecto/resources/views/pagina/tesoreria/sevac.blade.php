   ...
   @else
      @foreach ($reportes as $reporte)
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-2">
            <a href="{{ route('reporte.dowload', $reporte->archivo) }}" class="d-block btn btn-info pt-3 pb-3 text-left text-white">{{$reporte->titulo}} <i class="fa fa-download float-right mt-1"></i></a>
         </div>
         @endif
      @endforeach
   @endif
